...
<template>
  <div class="container">
    <div class="settings_nav">
      <div
        class="settings_nav_backbutton"
        @click="confirmBack"
      >
        <img
          id="back_purple"
          src="/public/images/interactive_editor/Vector_static.svg"
        >
        <div>
      ...
      <div
        class="settings_nav_main"
        :class="{ settings_active_nav: active_step === 'main' }"
      ...
      <div
        class="settings_nav_questions_button"
      ...
      <img
        v-if="!props.isFormComplete"
        id="lock"
        src="/public/images/interactive_editor/lock.svg"
      >
      <div
        v-if="!isFormComplete"
        class="settings_nav_questions_info"
      >
