...
<template>
  <div >
   ...
   <div class="interactive_edit_top_menu">
            <div>
                <button class="interactive_edit_backButton" @click="handleBackClick()" :class="{ back_to_all_settings: step === 2}">
  ...
  <general_settings :step="step" @update-step="step = $event" />
</template>
...
.interactive_edit_backButton {margin-left: 23px;;
    width: 229px;
    height: 62px;
    border-radius: 5px;
...
.back_to_all_settings{
  width: 280px;; height:62px;margin-left: 0px;;
}
