...
<template>
  <div class="interactive_body">
    <nav_bar />
    <div class="interactives_top_menu">
      <div>
        <button
          class="interactives_backButton"
          @click="goToMainMenu()"
        >
          Вернуться
        </button>
      ...
      <div
        class="interactives_top_menu_create_interactive"
        @click="create_new_interactive()"
      >
        Создать интерактив
      </div>
    </div>
    <div class="interactives_lists">
      <img
        id="interactives_line"
        src="/images/interactives/Group_107.svg"
      >
      <img
        id="interactives_line2"
        src="/images/interactives/Group_108.svg"
      >
      <interactives_list
        :header="'Непроведенные интерактивы'"
        :interactives_list="props.interactives_list.interactives_list_not_conducted
        "
        :status="'not_end'"
      />
      <interactives_list
        :header="'Проведенные интерактивы'"
        class="interactive_list_second"
        :interactives_list="props.interactives_list.interactives_list_conducted"
        :status="'end'"
      />
    </div>
  </div>
