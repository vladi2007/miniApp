            ...
            <div class="history_content_menu_info">
              ...
              <div class="pick_button">
                ...
                <button
                  ...
                  class="history_content_menu_info_button"
          ...
          <div class="history_content_list">
            ...
            >
              <div class="history_interactive">
                ...
                <button
                  v-if="!selectMany"
                  class="history_download"
                  @click="openPopup(interactive.interactive_id)"
                >
                  Выгрузить
                </button>
                <label
            ...
            <div
              v-if="props.data.interactives_list.length ===0"
              class="history_content_list_warn"
            >
