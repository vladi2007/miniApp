...
const defaultWinners = [
  { position: 1, score: 5, time: 2, username: "Иванов Иван Сергеевич", participant_id: "1", is_hidden: false, is_blocked: false },
  { position: 1, score: 5, time: 2, username: "Петров Петр Петрович", participant_id: "2", is_hidden: true, is_blocked: false },
  { position: 1, score: 5, time: 2, username: "Сидоров Сидор Сидорович", participant_id: "3", is_hidden: false, is_blocked: true },
]
  ...
  <div class="winners_table">
    <div class="table">
      ...
      <div class="winners_list">
        <div v-for="(winner, index) in defaultWinners" :key="index" class="winner_participant">
...
.score_participant_header {
  width: calc((37 / 390) * 100dvw);
  ;
  margin-left: calc((2 / 390) * 100dvw);
  ;
  display: flex;
  align-items: center;
  justify-content: center;
